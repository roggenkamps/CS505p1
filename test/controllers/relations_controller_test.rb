...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { description: @relation.description, name: @relation.name } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { description: @relation.description, name: @relation.name } }
